...
{
    /// <inheritdoc />
    public partial class profilefeatures1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlBackground = table.Column<string>(type: "text", nullable: true),
                    UrlProfile = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
